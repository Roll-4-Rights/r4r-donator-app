...
<template>
  <div class="channel-chat">
    ...
    <div v-if="!identity.username" class="name-gate">
      <p>Pick a display name to join the chat:</p>
      <input v-model="nameInput" @keyup.enter="join" placeholder="Your name" />
...
import { identity, setUsername } from '../identity'
...
onMounted(() => {
  if (identity.username) joinChannel(props.channel)
})

watch(() => props.channel, (newChannel) => {
  if (identity.username) joinChannel(newChannel)
})
