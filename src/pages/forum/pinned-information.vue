<template>
  <div class="subforum-page">
    <div class="welcome-blurb">
      ...
      <p>
        Create a Thread to share a little bit about yourself and your socials (note to self: add ability to add links, and the ability to add/delete)
      </p>
    </div>

    <div class="subforum-header">
      <h1>Introduce Yourself</h1>
      <button class="btn-create" @click="openCreateModal">+ New Thread</button>
    </div>
    ...
    <div v-else class="empty-state">
      <p>No threads yet. Be the first to introduce yourself!</p>
    </div>
